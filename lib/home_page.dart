                  ...
                  children: [
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        // Show buttons in a row if window is wide enough, otherwise stack them
  ...
  List<Widget> _buildButtons(BuildContext context) {
    return [
      ...
      LayoutBuilder(
        builder: (context, constraints) {
          return SizedBox(
            width: constraints.maxWidth > 800 ? 16.0 : 0,
            height: constraints.maxWidth <= 800 ? 12.0 : 0,
          );
        },
      ),
      Container(
        ...
        child: ElevatedButton(
          ...
          child: const Text('Começar', textAlign: TextAlign.center),
        ),
      ),
    ];
  }
